    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Permohonan Infrastruktur Baru</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Permohonan Infrastruktur Baru
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="app-content">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Daftar Permohonan Infrastruktur Baru</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center align-middle" style="width: 100px;">Jenis Koneksi</th>
                        ...
                        <tbody>
                            @foreach ($infrastruktur as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">{{ $item->jenis_koneksi }}</td>
                                    ...
                                    <td class="text-center align-middle">
                                        <form action="{{ route('update.infrastruktur.admin', $item->id) }}"
                                            method="POST" id="statusForm{{ $item->id }}">
                                            @csrf
                                            @method('PATCH')

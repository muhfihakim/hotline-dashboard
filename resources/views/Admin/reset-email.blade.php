    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Permohonan Reset Email</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Permohonan Reset Email
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="app-content">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Daftar Permohonan Reset Email</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center align-middle" style="width: 100px;">Nama Lengkap</th>
                                <th class="text-center align-middle" style="width: 100px;">Instansi</th>
                        ...
                        <tbody>
                            @foreach ($resetemail as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <form action="{{ route('update.resetemail.admin', $item->id) }}" method="POST"

    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Permohonan Virtual Private Server</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Permohonan Virtual Private Server
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="app-content">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Daftar Permohonan Virtual Private Server</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($vps as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <form action="{{ route('update.vps.admin', $item->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
